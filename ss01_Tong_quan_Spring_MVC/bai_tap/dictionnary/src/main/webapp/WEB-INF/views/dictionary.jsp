...
<form action="" method="get" class="mt-5" style="padding: 0 500px">
    ...
    <div class="input-group mb-3 mt-3">
        ...
        <input <c:if test="${result == null}">value="Sorry, we couldn't find this word" </c:if>
                <c:if test="${result != null}">value="${result}" </c:if>
                readonly type="text" class="form-control" aria-label="Dollar amount (with dot and two decimal places)">
    </div>
